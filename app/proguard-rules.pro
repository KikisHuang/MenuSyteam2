...
##-libraryjars libs/fluent-hc-4.3.1.jar
#-keep class org.apache.http.cloent.fluent.** { *; }
#
##-libraryjars libs/httpclient-cache-4.3.1.jar
...
#
##-libraryjars libs/universal-image-loader-1.9.5-javadoc.jar
##-libraryjars libs/universal-image-loader-1.9.5-javadoc.jar
#
##避免混淆泛型 如果混淆报错建议关掉
